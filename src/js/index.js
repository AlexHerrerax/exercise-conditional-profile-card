...
function render(variables = {}) {
  ...
  if (variables.lastname === null) variables.lastname = "NoMeAcuerdoQue";
  ...
  if (variables.role === null) variables.role = "Web Developer"; //rol
  if (variables.city === null) variables.city = "Miami"; //city
  if (variables.country === null) variables.country = "Usa"; //Country
